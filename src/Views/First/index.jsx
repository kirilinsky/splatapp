      ...
      <div className="container">
        <div className="wrapper">
          <div className="download">
            ...
            Выберите <span className="red">подходящее отбеливание</span> для ваших зубов за 3 простых шага. 
            <span className="red"> Скачайте приложение</span>, наведите 
            камеру на вашу улыбку и получите <span className="red">профессиональные рекомендации</span> от экспертов!
            </h1>
